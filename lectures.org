...
\[
C = \{x^2 + y^2 = 1, -1 < z < 1\}, \quad  N(x, y, z) = (x, y, 0).
\]
...
\[
\gamma(t) = (\cos t, \sin t, z_0), \gamma'(t) = (-\sin t, \cos t, 0), \gamma''(t) = (-\cos t, - \sin, 0).
\]
\[
...
\[
\gamma(t) = (1, 0, t), \gamma'(t) = (0, 0, 1), \gamma''(t) = (0, 0, 0).
\]
\[
...
\[
\gamma(t) = (\cos t, \sin t, t), \gamma'(t) = (-\sin t, \cos t, 1), \gamma''(t) = (-\cos t, - \sin, 0).
\]
\[
N(\gamma(t)) = (\cos t, \sin t, 0), n_S(\gamma(t)) = (0, 0, 1).
\]
...
\[
\gamma(t) = (\cos(\cos t), \sin(\cos t), \sin t), \gamma'(t) = (\sin(\cos t) \sin t, ), \gamma''(t) = (-\cos t, - \sin, 0).
\]
\[
N(\gamma(t)) = (\cos t, \sin t, 0), n_S(\gamma(t)) = (0, 0, 1).
\]
...
#+BEGIN_theorem
Let \(\gamma, \sigma : I \to S\) with \(\gamma(0) = \sigma(0)
#+END_theorem
